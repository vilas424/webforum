...
<body>
	...
	<div class="heading">
    	Make an appointment with PRINCIPAL
    </div>
...
<form name="login-form" class="login-form" action="" method="post">
    ...
    <!--Buttons-->
    <div class="footer">
    <!--Login button--><input type="button" name="submit" value="Login" class="button" onclick="fun()"/><!--END Login button-->
    <!--Register--><a href="register.html" name="submit"  class="register" >Register</a><!--END Register-->
    </div>
    <!--END Buttons-->
